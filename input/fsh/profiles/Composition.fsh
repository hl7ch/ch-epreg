...
* subject only Reference(ChEpregPatient)
* section contains 
    careTeam 0..1
* section[careTeam].code = $loinc#85847-2 // "Patient Care team information"
* section[careTeam].entry MS
* section[careTeam].entry only Reference(ChEpregPractitionerRole)
...
Description: "This mapping illustrates the relationship between the CH EPREG Composition profile and the concept of the pregnancy passport."
