...
* code ^binding.description = "See also [Mapping Laboratory Results](mapping-concept-valuesets.html#laboratory-results)." 
* subject 1..
...
* value[x] MS 
* value[x] ^short = "See also 'Mapping Measurement Results'."
* component.value[x] MS                     
* component.value[x] ^short = "See also 'Mapping Measurement Results'."
