...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 5.1.1 Stammdaten | 5.1.1 Données de base |   |   |   |   |   |   |
...
| 3.2.2. Vorname | 3.2.2. Prénom | 0..1 | R | String |   |   |   |
| 3.3. Telefon | 3.3. N° de téléphone | 0..1 | R |   |   |   |   |
| 3.3.1. Festnetz | 3.3.1. Fixe | 0..1 | O | String |   |   |   |
...
| 5. Behandelnder Leistungserbringender | 5. Fournisseur de prestations | 0..\* | R |   | Dieses Element kann mehrmals vorkommen, so dass damit zum Beispiel ein Gynäkologe, eine Hebamme und der Hausarzt abgebildet werden können. | Composition.section:careTeam \n-> CH EPREG PractitionerRole: Treating Healthcare Provider \n -> CH EPREG Practitioner: Treating Healthcare Provider\n -> CH EPREG Organization: Treating Healthcare Provider |   |
...
| 5.3. Bemerkungen | 5.3. Remarques | 0..1 | O | String |   | can be textually described here:\nComposition.section:careTeam.text |   |
...
| 5.1.2 Anamnese & Risikofaktoren | 5.1.2 Anamnèse et facteurs de risque |   |   |   |   |   |   |
...
| 7.1.2. Körpergrösse | 7.1.2. Taille | 0..1 | O | Quantität | Grösse in cm\n248334005 | Length of body (observable entity) LOINC: 8302-2 | Body height |   |   |
| 7.1.3. Körpergewicht vor der Schwangerschaft | 7.1.3. Poids avant la grossesse | 0..1 | O | Quantität | Gewicht in kg. 1 Nachkommastelle\n400967004 | Baseline weight (observable entity) LOINC: 29463-7 | Body weight |   |   |
...
| 5.1.3 Terminbestimmung & Pränataldiagnostik | 5.1.3 Calcul du terme et diagnostic prénatal |   |   |   |   |   |   |
...
| 5.1.4 Serologische- & Laboruntersuchungen | 5.1.4 Sérologies et analyses de laboratoire |   |   |   |   |   |   |
...
| 11.3. Laboruntersuchung | 11.3. Analyse de laboratoire | 0..\* | O |   | 108252007 | Laboratory procedure (procedure) | Composition.section:lab-subsections.\n- section:bloodBankStudies.entry\n- section:chemistryStudies.entry\n- section:hematologyStudies.entry\n- section:microbiologyStudies.entry\n-> CH EPREG Observation (Base): Results Laboratory | Modelled according to CH LAB-Report: https://fhir.ch/ig/ch-lab-report/StructureDefinition-ch-lab-report-composition.html\n- section:lab-subsections with sections according to https://hl7.eu/fhir/laboratory/ValueSet-lab-studyType-eu-lab.html\n- Representation of the common sections used for the preg cy passport, but other sections can be added |
...
| 5.1.5 Stationäre Aufnahme in der Schwangerschaft | 5.1.5 Hospitalisation pendant la grossesse |   |   |   |   |   |   |
...
| 5.1.6 Schwangerschaftsverlauf | 5.1.6 Évolution de la grossesse |   |   |   |   | Composition.setion:preg cyProgress |   |
| 13. Untersuchung | 13. Examen | 0..1 | O |   |   | Composition.setion:pregProgress.entry:pregVisit \n-> CH EPREG Encounter: Mother\n-> CH EPREG Encounter: Child |   |
| 13.1. Nummer | 13.1. Numéro | 0..1 | O | Count | Nummer der Untersuchung | Encounter.extension:visitNumber\n-> Extension.valuePositiveInt |   |
| 13.2. Zeitpunkt der Untersuchung | 13.2. Date de l’examen | 1..1 | M |   |   | Observation.effective[x] |   |
| 13.2.1. Datum | 13.2.1. Date | 1..1 | M | Datum | Datum der Ultraschalluntersuchung | Encounter.period.start\nEncounter.period.end |   |
| 13.2.2. Schwangerschaftswoche+Tage | 13.2.2. Semaine de grossesse + jours | 0..1 | R |   | Schwangerschaftswoche in der die Ultraschalluntersuchung stattgefunden hat\n1156738004 | Fetal gestational age in weeks and days (observable entity) | Composition.section:pregProgress.entry:gestationalAge\n-> CH EPREG Observation (Mother): Gestational Age in Days\nObservation.valueQuantity | Gestational age in days, analogous to existing usage in Switzerland:\n- https://chmed20af.emediplan.ch/fhir/StructureDefinition-chmed20af-obs-timeofgestation.html \n- https://doc.mednet.swiss/fhir/StructureDefinition-mni-obs-timeOfGestation.html |
...
| 13.3. Angaben zur Schwangeren | 13.3. Informations sur la femme enceinte | 0..1 | O |   |   | Observation.subject\n-> CH EPREG Patient: Mother | see note about Observation for mother and (unborn) child below |
| 13.3.1. Aktuelles Gewicht | 13.3.1. Poids actuel | 0..1 | O | Quantität | Aktuelles Gewicht in kg. 1 Nachkommastelle | Compostion.section:pregProgress.entry:bodyWeight\n-> CH EPREG Observation (Mother): Body Weight\nObservation.valueQuantity | conforms to https://hl7.org/fhir/R4/bodyweight.html |
| 13.3.2. Gewichtszunahme | 13.3.2. Prise de poids | 0..1 | O | Quantität | Gewichtszunahme in kg. 1 Nachkommastelle | Composition.section:weightGain\n-> CH EPREG Observation (Mother): Weight Gain\nObservation.valueQuantity |   |
| 13.3.3. Blutdruck | 13.3.3. Pression artérielle | 0..1 | O |   | 75367002 | Blood pressure (observable entity)\nLOINC: 85354-9 | Blood pressure panel with all children optional | Composition.section:pregProgress.entry:bloodPressure\n-> CH EPREG Observation (Mother): Blood Pressure | conforms to https://hl7.org/fhir/R4/bp.html |
| 13.3.3.1. Systolischer Blutdruckwert | 13.3.3.1. Valeur de la pression artérielle systolique | 1..1 | M | Quantität | Angabe in mmHg\n271649006 | Systolic blood pressure (observable entity) LOINC: 8480-6 | Systolic blood pressure | Observation.component:SystolicBP.valueQuantity |   |
| 13.3.3.2. Diastolischer Blutdruckwert | 13.3.3.2. Valeur de la pression artérielle diastolique | 1..1 | M | Quantität | Angabe in mmHg\n271650006 | Diastolic blood pressure (observable entity) LOINC: 8462-4 | Diastolic blood pressure | Observation.component.value\nObservation.component:DiastolicBP.valueQuantity |   |
...
| 13.3.8. Weitere Untersuchungen und Fragen | 13.3.8. Autres examens et questions | 0..1 | O |   |   | Composition.section:pregProgress.entry\n-> CH EPREG Observation (Base): Preg cy Progress | Additional Observation entries, representing the specific examination/question can be added in the section pregProgress. \nSee also the according guidance section in the IG for details: guidance-vs-mapping.html#further-examinations |
...
| 5.1.7 Ultraschalluntersuchungen & CTG-Kontrollen | 5.1.7 Échographies et contrôles CTG |   |   |   |   |   |   |
...
| 14.6.2.1. Untersuchte Parameter | 14.6.2.1. Paramètre examiné | 1..1 | M | Code | 5.1.8 Value Set: Abort\ gaben zum Fötus/Kind (Ultraschall) |   |   |
...
| 5.1.9 Geburt | 5.1.8 Accouchement |   |   |   |   |   |   |
...
| 16.5.9. Körperlänge | 16.5.9. Taille | 0..1 | O | Quantität | Länge in cm. 1 Nachkommastelle\n169886007 | Birth length (observable entity) LOINC: 89269-5 | Body height Measured --at birth |   |   |
| 16.5.10. Kopfumfang | 16.5.10. Circonférence céphalique | 0..1 | O | Quantität | Kopfumfang in cm. 1 Nachkommastelle\n169876006 | Birth head circumference (observable entity) LOINC: 9843-4 | Head Occipital-frontal circumference |   |   |
...
| 5.1.10 Wochenbett | 5.1.9 Post-partum |   |   |   |   |   |   |
